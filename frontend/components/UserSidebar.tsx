...
import { FaChartLine, FaUser, FaFolderOpen, FaEnvelope, FaSignOutAlt, FaGlobe } from 'react-icons/fa';
...
export default function UserSidebar({ user }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { icon: FaFolderOpen, label: 'My Projects', path: '/user/projects' },
    { icon: FaEnvelope, label: 'Messages', path: '/user/messages' },
  ];
